...
/* package haskell-json-parser-0.1.0.0 */
#ifndef VERSION_haskell_json_parser
#define VERSION_haskell_json_parser "0.1.0.0"
#endif /* VERSION_haskell_json_parser */
#ifndef MIN_VERSION_haskell_json_parser
#define MIN_VERSION_haskell_json_parser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_json_parser */
...
#define CURRENT_PACKAGE_KEY "haskell-json-parser-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-json-parser-0.1.0.0-inplace"
